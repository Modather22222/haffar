...
class Question {
  ...
  final List<String>? itemCategories; // for classification: '0' (first zone) or '1' (second zone) per option
  final int xpReward;
  ...
  static QuestionType _typeFromString(String value) => QuestionType.values.firstWhere(
        (t) => t.name == value,
  ...
  factory Question.fromMap(Map<String, dynamic> map) => Question(
        ...
        itemCategories: ((map['item_categories'] as List?) ?? const []).cast<String>(),
  ...
  String? get correctAnswerText {
    if (correctWords != null && correctWords!.isNotEmpty) return correctWords!.first;
