    ...
    switch (question.type) {
      case QuestionType.multipleChoice:
        return MultipleChoiceQuestion(
          pathTitle: pathTitle, questionText: question.text, hint: question.hint,
          options: question.options, correctIndex: question.correctIndex,
          xpReward: question.xpReward, onBack: onBack, onSkip: onSkip,
          onNext: onNext, onSubmitAnswer: onSubmitAnswer, locked: locked,
        );
      case QuestionType.trueFalse:
        return TrueFalseQuestion(
          pathTitle: pathTitle, questionText: question.text,
          xpReward: question.xpReward, correctAnswer: question.correctIndex == 0,
          onBack: onBack, onSkip: onSkip, onNext: onNext, onSubmitAnswer: onSubmitAnswer, locked: locked,
        );
      case QuestionType.fillBlank:
        return FillBlankQuestion(
          pathTitle: pathTitle, questionText: question.text, info: question.hint,
      ...
      case QuestionType.definition:
        return DefinitionQuestion(
          pathTitle: pathTitle, term: question.text,
      ...
      case QuestionType.reading:
        return ReadingQuestion(
          pathTitle: pathTitle, passage: question.passage ?? question.text,
          questionText: question.text, options: question.options,
          correctIndex: question.correctIndex, xpReward: question.xpReward,
          onBack: onBack, onSkip: onSkip, onNext: onNext, onSubmitAnswer: onSubmitAnswer, locked: locked,
        );
      case QuestionType.calculation:
        return CalculationQuestion(
          pathTitle: pathTitle, questionText: question.text,
          hint: question.hint, formula: question.passage,
          options: question.options, correctWords: question.correctWords ?? [],
          correctIndex: question.correctIndex, xpReward: question.xpReward,
          onBack: onBack, onSkip: onSkip, onNext: onNext, onSubmitAnswer: onSubmitAnswer, locked: locked,
        );
      case QuestionType.diagram:
        return DiagramQuestion(
          pathTitle: pathTitle, questionText: question.text,
          imageUrl: question.imageUrl ?? '', options: question.options,
          correctIndex: question.correctIndex, xpReward: question.xpReward,
          onBack: onBack, onSkip: onSkip, onNext: onNext, onSubmitAnswer: onSubmitAnswer, locked: locked,
        );
      case QuestionType.classification:
        return ClassificationQuestion(
          pathTitle: pathTitle, questionText: question.text,
          items: question.options, itemCategories: question.itemCategories ?? [],
      ...
      case QuestionType.composition:
        return ExplanationQuestion(
          pathTitle: pathTitle, questionText: question.text,
          passage: question.passage, xpReward: question.xpReward,
          onBack: onBack, onSkip: onSkip, onNext: onNext, onSubmitAnswer: onSubmitAnswer, locked: locked,
        );
    }
  }
