...
import 'onboarding_five_screen.dart';
                      ...
                      child: subjects.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, i) {
                                final s = subjects[i];
                                final selected = provider.selectedSubjectIds.contains(s.id);
                                return Padding(
                                  padding: const EdgeInsets.only(bottom: 8),
                                  child: _SubjectRow(
                                    subject: s,
                                    selected: selected,
                                    onTap: () => provider.toggleSelectedSubject(s.id),
                                  ),
                                );
                              },
                            ),
...
class _SubjectRow extends StatelessWidget {
  ...
  const _SubjectRow({required this.subject, required this.selected, required this.onTap});
        ...
        child: Row(
          children: [
            if (asset != null)
              ...
              Container(width: 56, height: 56, color: HaffarColors.primary, child: Center(child: Text(subject.icon, style: const TextStyle(fontSize: 24)))),
            ...
            Expanded(
              child: Padding(
                ...
                child: Text(
                  subject.name,
                   style: const TextStyle(fontFamily: 'DIN2014Rounded', fontSize: 15, fontWeight: FontWeight.w700, color: HaffarColors.grey1),
